...
class IoUDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return image, torch.tensor([avg_iou], dtype=torch.float)
...
# Normalize targets
target_column = 'avg_iou'
data[target_column], target_mean, target_std = normalize_targets(data[target_column])
...
with open('norm_params_only_avg_iou.json', 'w') as f:
...
best_model_path = 'best_predict_only_avg_iou_model_CNN.pth'
