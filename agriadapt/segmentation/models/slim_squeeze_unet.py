...
from agriadapt.segmentation.models.slimmable_ops import (
    SlimmableConv2d,
...
class SlimSqueezeUNet(nn.Module):
    ...
    def obs_space(self, output_layer=None):
        flattened_space = None
        if output_layer == "fire08":
            flattened_space = 512 * 32 * 32
        elif output_layer == "conv2":
            flattened_space = 192 * 32 * 32
